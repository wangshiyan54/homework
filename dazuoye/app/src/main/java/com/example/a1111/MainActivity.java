...
public class MainActivity extends AppCompatActivity implements View.OnClickListener,View.OnFocusChangeListener{
    ...
    private String[] typeArray = {"个人用户", "公司用户", "18990054 王士彦"};
    ...
    private class HideTextWatcher implements TextWatcher {
        ...
        public void afterTextChanged(Editable s) {
            ...
            if ((mStr.length() == 11 && mMaxLength == 11) ||
                ...
                ViewUtil.hideOneInputMethod(com.example.a1111.MainActivity.this, mView);
            }
        }
    }
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.btn_forget) { // 点击了“忘记密码”按钮
            ...
            if (rb_password.isChecked()) { // 选择了密码方式校验，此时要跳到找回密码页面
                Intent intent = new Intent(this, com.example.a1111.LoginForgetActivity.class);
                // 携带手机号码跳转到找回密码页面
