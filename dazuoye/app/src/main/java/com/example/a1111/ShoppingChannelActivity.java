...
import com.example.a1111.adapter.GoodsAdapter;
import com.example.a1111.adapter.GoodsAdapter.addCartListener;
import com.example.a1111.bean.CartInfo;
import com.example.a1111.bean.GoodsInfo;
import com.example.a1111.database.CartDBHelper;
import com.example.a1111.database.GoodsDBHelper;
import com.example.a1111.util.DateUtil;
import com.example.a1111.util.FileUtil;
import com.example.a1111.util.SharedUtil;
...
public class ShoppingChannelActivity extends AppCompatActivity implements View.OnClickListener, addCartListener{
    ...
    private void downloadGoods() {
        ...
        mFirst = SharedUtil.getIntance(this).readShared("first", "true");
        // 获取当前App的私有存储路径
        String path = com.example.a1111.MainApplication.getInstance().getExternalFilesDir(
        ...
        if (mFirst.equals("true")) { // 如果是首次打开
            ...
            for (int i = 0; i < goodsList.size(); i++) {
                ...
                com.example.a1111.MainApplication.getInstance().mIconMap.put(rowid, thumb);
            ...
            for (int i = 0; i < goodsArray.size(); i++) {
                ...
                // 把该位图对象保存到应用实例的全局变量中
                com.example.a1111.MainApplication.getInstance().mIconMap.put(info.rowid, thumb);
            }
        }
        // 把是否首次打开写入共享参数
        SharedUtil.getIntance(this).writeShared("first", "false");
